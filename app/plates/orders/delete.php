...
<div class="modal-dialog modal-dialog-centered">
  <div class="modal-content">
    ...
    <div class="modal-footer border-top-0 bg-light">
      ...
      <?php echo $form->button('Cancel')->withClass('btn btn-link text-secondary text-decoration-none')->with('@click', 'close')->disablesOn('loading') ?>
      <?php echo $form->button('Delete')->withClass('btn btn-danger')->onClick('remove(id)')->disablesOn('loading') ?>
    </div>
  </div>
</div>
</div>
