...
<div class="modal-dialog modal-dialog-centered">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <p>Are you sure that you want to delete the client <span class="fw-bold" x-text="name"></span>?</p>
    ...
    <div class="modal-footer border-top-0 bg-light">
      ...
      <?= $form->button('Delete Item', 'btn btn-danger')->onClick('remove(id)')->disablesOn('loading') ?>
    </div>
  </div>
</div>
</div>
